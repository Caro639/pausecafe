 ...
 */
final class Version20250319215651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, promo_id INT DEFAULT NULL, user_id INT NOT NULL, reference VARCHAR(20) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_E52FFDEEAEA34913 (reference), INDEX IDX_E52FFDEED0C07AFF (promo_id), INDEX IDX_E52FFDEEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEED0C07AFF FOREIGN KEY (promo_id) REFERENCES promo (id)');
        ...
        $this->addSql('ALTER TABLE promo ADD CONSTRAINT FK_B0139AFB3DDD47B7 FOREIGN KEY (coupons_types_id) REFERENCES coupons_types (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE promo DROP FOREIGN KEY FK_B0139AFB3DDD47B7');
